...
var G__15116 = devtools.prefs.pref(v);
v = G__15116;
continue;
} else {
return v;
...
}catch (e14965){var _e__11968__auto__ = e14965;
return false;
}})();
...
}catch (e14974){var _e__11968__auto__ = e14974;
return false;
}})();
...
}catch (e14984){var _e__11968__auto__ = e14984;
return false;
}}
}
});
...
var vec__15025 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15025,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15025,(1),null);
...
return cljs.core.some((function (p1__15044_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15044_SHARP_);
}),template);
});
