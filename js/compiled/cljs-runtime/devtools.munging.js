...
var temp__5802__auto____$1 = (o12153["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12154 = temp__5802__auto____$1;
return (o12154["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11932__auto__ = f;
return (o__11932__auto__["toString"]).call(o__11932__auto__);
} else {
return "";
}
}catch (e12160){var _ = e12160;
return "";
}});
...
try{var o__11932__auto___13017 = t;
(o__11932__auto___13017["cljs$lang$ctorPrWriter"]).call(o__11932__auto___13017,t,writer);
}catch (e12182){var __13020 = e12182;
}
...
var char_code = (function (){var o__11932__auto__ = (new String(char$));
return (o__11932__auto__["charCodeAt"]).call(o__11932__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11932__auto__ = String;
return (o__11932__auto__["fromCharCode"]).call(o__11932__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12223 = num_code;
switch (G__12223) {
case (1):
return (185);
...
var o__11932__auto__ = String;
return (o__11932__auto__["fromCharCode"]).call(o__11932__auto__,superscript_code);
});
/**
...
}catch (e12249){var _e__11968__auto__ = e12249;
return false;
}})())){
...
var vec__12257 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12257,(0),null);
...
var len__5769__auto___13039 = arguments.length;
var i__5770__auto___13040 = (0);
while(true){
if((i__5770__auto___13040 < len__5769__auto___13039)){
args__5775__auto__.push((arguments[i__5770__auto___13040]));

var G__13041 = (i__5770__auto___13040 + (1));
i__5770__auto___13040 = G__13041;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12311){
var vec__12312 = p__12311;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12312,(0),null);
...
var G__13064 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__13065 = cljs.core.butlast(remaining_tokens);
name_tokens = G__13064;
remaining_tokens = G__13065;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12297){
var G__12298 = cljs.core.first(seq12297);
var seq12297__$1 = cljs.core.next(seq12297);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12298,seq12297__$1);
}));
...
var vec__12354 = cljs.core.split_with((function (p1__12335_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12335_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12354,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12354,(1),null);
...
var vec__12381 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12381,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12381,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__13093 = cljs.core.rest(remaining_tokens);
var G__13094 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__13093;
name_tokens = G__13094;
continue;
} else {
...
var vec__12415 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12415,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12415,(1),null);
var vec__12418 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12418,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12418,(1),null);
var vec__12421 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12421,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12421,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12421,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12421,(3),null);
...
var vec__12464 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12464,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12464,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12464,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12464,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12464,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12464,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12483 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12483,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12483,(1),null);
var vec__12493 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12493,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12493,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12514 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12514) : devtools.munging.parse_fn_info_deep.call(null,G__12514));
})()));
}
} else {
return fn_info;
...
var G__13122 = (arity + (1));
var G__13123 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12592){
var vec__12595 = p__12592;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12595,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12595,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12636_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12636_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12637_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12637_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___13146 = arguments.length;
var i__5770__auto___13147 = (0);
while(true){
if((i__5770__auto___13147 < len__5769__auto___13146)){
args__5775__auto__.push((arguments[i__5770__auto___13147]));

var G__13148 = (i__5770__auto___13147 + (1));
i__5770__auto___13147 = G__13148;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12674){
var vec__12676 = p__12674;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12676,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12661){
var G__12662 = cljs.core.first(seq12661);
var seq12661__$1 = cljs.core.next(seq12661);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12662,seq12661__$1);
}));
...
var map__12791 = options;
var map__12791__$1 = cljs.core.__destructure_map(map__12791);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12791__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12791__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12791__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12791__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12793 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12793,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12793,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12793,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12793,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12793,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12793,(5),null);
...
var o__11932__auto__ = f;
return (o__11932__auto__["getBasis"]).call(o__11932__auto__);
});
/**
...
}catch (e12830){var _e__11968__auto__ = e12830;
...
var G__13164 = (obj[cljs.core.first(path)]);
var G__13165 = cljs.core.rest(path);
obj = G__13164;
path = G__13165;
continue;
} else {
...
var _STAR_ = (function (accum,p__12906){
var vec__12907 = p__12906;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12907,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12907,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12924){
var vec__12926 = p__12924;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12926,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12926,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12926,(2),null);
...
var post_process = (function (p__12967){
var vec__12968 = p__12967;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12968,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12968,(1),null);
...
return (obj[cljs.core.first(p1__12950_SHARP_)]);
}),sorted_matches);
