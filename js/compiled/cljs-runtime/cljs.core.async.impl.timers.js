...
var i_15871 = (0);
while(true){
if((i_15871 < arr.length)){
(arr[i_15871] = null);

var G__15877 = (i_15871 + (1));
i_15871 = G__15877;
continue;
} else {
}
...
var i_15903 = (self__.level + (1));
while(true){
if((i_15903 <= (new_level + (1)))){
(update[i_15903] = self__.header);

var G__15906 = (i_15903 + (1));
i_15903 = G__15906;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_15908 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_15908[i]));
} else {
x__$2.forward.push((((i < links_15908.length))?(links_15908[i]):null));
}

if((i < links_15908.length)){
(links_15908[i] = x__$2);
} else {
links_15908.push(x__$2);
}
...
var i_15914 = (0);
while(true){
if((i_15914 <= self__.level)){
var links_15915 = (update[i_15914]).forward;
if((x__$1 === (((i_15914 < links_15915.length))?(links_15915[i_15914]):null))){
(links_15915[i_15914] = (x__$1.forward[i_15914]));

var G__15919 = (i_15914 + (1));
i_15914 = G__15919;
continue;
} else {
var G__15921 = (i_15914 + (1));
i_15914 = G__15921;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__15954 = nx;
var G__15955 = (level__$1 - (1));
x = G__15954;
level__$1 = G__15955;
continue;
} else {
var G__15957 = x;
var G__15958 = (level__$1 - (1));
x = G__15957;
level__$1 = G__15958;
continue;
}
