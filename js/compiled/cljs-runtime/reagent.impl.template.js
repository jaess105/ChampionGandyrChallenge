...
while (G__19374__i < G__19374__a.length) {G__19374__a[G__19374__i] = arguments[G__19374__i + 0]; ++G__19374__i;}
  args = new cljs.core.IndexedSeq(G__19374__a,0,null);
} 
return G__19371__delegate.call(this,args);};
G__19371.cljs$lang$maxFixedArity = 0;
G__19371.cljs$lang$applyTo = (function (arglist__19376){
...
while (G__19386__i < G__19386__a.length) {G__19386__a[G__19386__i] = arguments[G__19386__i + 0]; ++G__19386__i;}
  args = new cljs.core.IndexedSeq(G__19386__a,0,null);
} 
...
var G__18949 = props;
var G__18949__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18949,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__18949);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18949__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__18966 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18966,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__18966;
}
})(),id_class);
...
var G__18969 = (cljs.core.count(argv) - first_child);
switch (G__18969) {
case (0):
...
var vec__19009 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19009,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19009,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19009,(2),null);
...
var temp__5808__auto___19436 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19436 == null)){
} else {
var key_19438 = temp__5808__auto___19436;
(jsprops.key = key_19438);
}
...
var temp__5808__auto___19445 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19445 == null)){
} else {
var key_19447 = temp__5808__auto___19445;
(jsprops.key = key_19447);
}
...
var temp__5808__auto___19454 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___19454 == null)){
} else {
var key_19457 = temp__5808__auto___19454;
(jsprops.key = key_19457);
}
...
var temp__5808__auto___19489 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19489 == null)){
} else {
var key_19494 = temp__5808__auto___19489;
(jsprops.key = key_19494);
}
...
var temp__5808__auto___19501 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19501 == null)){
} else {
var key_19504 = temp__5808__auto___19501;
(jsprops.key = key_19504);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19098_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__19098_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__19118 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19118,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19118,(1),null);
...
break;
default:
var G__19518 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__19519 = compiler;
v = G__19518;
compiler = G__19519;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template19223 = (function (opts,id,fn_to_element,parse_fn,meta19224){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template19223.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19225,meta19224__$1){
var self__ = this;
var _19225__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template19223(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta19224__$1));
}));

(reagent.impl.template.t_reagent$impl$template19223.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19225){
var self__ = this;
var _19225__$1 = this;
return self__.meta19224;
}));

(reagent.impl.template.t_reagent$impl$template19223.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template19223.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template19223.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template19223.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template19223.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template19223.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta19224","meta19224",-1613615279,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template19223.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template19223.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template19223");

(reagent.impl.template.t_reagent$impl$template19223.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template19223");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template19223.
 */
reagent.impl.template.__GT_t_reagent$impl$template19223 = (function reagent$impl$template$__GT_t_reagent$impl$template19223(opts,id,fn_to_element,parse_fn,meta19224){
return (new reagent.impl.template.t_reagent$impl$template19223(opts,id,fn_to_element,parse_fn,meta19224));
});
...
return (new reagent.impl.template.t_reagent$impl$template19223(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
