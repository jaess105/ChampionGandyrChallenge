...
return [(function (){var pred__20070 = cljs.core.instance_QMARK_;
var expr__20071 = reactive_val;
if(cljs.core.truth_((pred__20070.cljs$core$IFn$_invoke$arity$2 ? pred__20070.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__20071) : pred__20070.call(null,reagent.ratom.RAtom,expr__20071)))){
return "ra";
} else {
if(cljs.core.truth_((pred__20070.cljs$core$IFn$_invoke$arity$2 ? pred__20070.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__20071) : pred__20070.call(null,reagent.ratom.RCursor,expr__20071)))){
return "rc";
} else {
if(cljs.core.truth_((pred__20070.cljs$core$IFn$_invoke$arity$2 ? pred__20070.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__20071) : pred__20070.call(null,reagent.ratom.Reaction,expr__20071)))){
return "rx";
} else {
if(cljs.core.truth_((pred__20070.cljs$core$IFn$_invoke$arity$2 ? pred__20070.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__20071) : pred__20070.call(null,reagent.ratom.Track,expr__20071)))){
return "tr";
} else {
return "other";
}
