...
var G__15384 = (i__5770__auto___15379 + (1));
i__5770__auto___15379 = G__15384;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15174){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15175,G__15176,seq15174__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15244_SHARP_){
return (!((cljs.core.meta(p1__15244_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15293__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e15300){var _e__11968__auto__ = e15300;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e15306){var _e__11968__auto__ = e15306;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__15322 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__15323 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__15323);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15331__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__15322);
}});
...
var temp__5802__auto___15469 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___15469)){
var managed_print_level_15470 = temp__5802__auto___15469;
var _STAR_print_level_STAR__orig_val__15350_15471 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__15351_15472 = managed_print_level_15470;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__15351_15472);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__15339_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__15339_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__15350_15471);
}} else {
job_fn();
}
