...
(re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__21744){
var map__21745 = p__21744;
var map__21745__$1 = cljs.core.__destructure_map(map__21745);
var m = map__21745__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21745__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var comment = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21745__$1,new cljs.core.Keyword(null,"comment","comment",532206069));
var before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21745__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21745__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__5802__auto___21931 = cljs.core.seq(clojure.set.difference.cljs$core$IFn$_invoke$arity$variadic(cljs.core.set(cljs.core.keys(m)),re_frame.interceptor.mandatory_interceptor_keys,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_frame.interceptor.optional_interceptor_keys], 0)));
if(temp__5802__auto___21931){
var unknown_keys_21932 = temp__5802__auto___21931;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: ->interceptor",m,"has unknown keys:",unknown_keys_21932], 0));
} else {
}
} else {
}

var G__21752 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__5045__auto__ = id;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21752,new cljs.core.Keyword(null,"comment","comment",532206069),comment);
} else {
return G__21752;
}
}));
...
/** @this {Function} */
(re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq21733){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21733));
}));
...
var args__5775__auto__ = [];
var len__5769__auto___21950 = arguments.length;
var i__5770__auto___21952 = (0);
while(true){
if((i__5770__auto___21952 < len__5769__auto___21950)){
...
/** @this {Function} */
(re_frame.interceptor.update_effect.cljs$lang$applyTo = (function (seq21801){
...
var G__21804 = cljs.core.first(seq21801__$2);
var seq21801__$3 = cljs.core.next(seq21801__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21802,G__21803,G__21804,seq21801__$3);
}));
...
/** @this {Function} */
(re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq21832){
...
var G__21835 = cljs.core.first(seq21832__$2);
var seq21832__$3 = cljs.core.next(seq21832__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21833,G__21834,G__21835,seq21832__$3);
}));
...
re_frame.interceptor.invoke_interceptor_fn = (function re_frame$interceptor$invoke_interceptor_fn(p__21850,interceptor,direction){
var map__21851 = p__21850;
var map__21851__$1 = cljs.core.__destructure_map(map__21851);
var context = map__21851__$1;
var original_exception_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21851__$1,new cljs.core.Keyword("re-frame.interceptor","original-exception?","re-frame.interceptor/original-exception?",-527923945));
...
/** @this {Function} */
(re_frame.interceptor.merge_ex_data.cljs$lang$applyTo = (function (seq21897){
var G__21898 = cljs.core.first(seq21897);
var seq21897__$1 = cljs.core.next(seq21897);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21898,seq21897__$1);
}));
...
var map__21911 = cljs.core.ex_data(re_frame_error);
var map__21911__$1 = cljs.core.__destructure_map(map__21911);
var event_v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21911__$1,new cljs.core.Keyword(null,"event-v","event-v",1378681365));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21911__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var interceptor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21911__$1,new cljs.core.Keyword(null,"interceptor","interceptor",1127739076));
var event_handler_QMARK_ = (function (){var fexpr__21912 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fx-handler","fx-handler",-549783097),null,new cljs.core.Keyword(null,"db-handler","db-handler",579530098),null,new cljs.core.Keyword(null,"ctx-handler","ctx-handler",-1777672230),null], null), null);
return (fexpr__21912.cljs$core$IFn$_invoke$arity$1 ? fexpr__21912.cljs$core$IFn$_invoke$arity$1(interceptor) : fexpr__21912.call(null,interceptor));
})();
...
}catch (e21923){var e = e21923;
var G__21924 = cljs.core.ex_cause(e);
var G__21925 = re_frame.interceptor.merge_ex_data.cljs$core$IFn$_invoke$arity$variadic(e,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"event-v","event-v",1378681365),event_v], null)], 0));
return (error_handler.cljs$core$IFn$_invoke$arity$2 ? error_handler.cljs$core$IFn$_invoke$arity$2(G__21924,G__21925) : error_handler.call(null,G__21924,G__21925));
}}
});
